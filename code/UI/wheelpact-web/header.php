...
<head>
    ...
    <link rel="stylesheet" href="assets/css/wheelpact-styles.css">
...
<body>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <!-- <div class="location-wrapper">  
                                    <img src="assets/images/mumbai-img.jpg">
                                </div> -->
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        <div class="login-input mt-4">
                            ...
                            <input type="tel" class="brand-input" id="loginNumber">
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="#" type="submit" class="dg-brand-btn" data-bs-target="#otpModal" data-bs-toggle="modal" data-bs-dismiss="modal" onclick="OTPMessage()">Send OTP</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="review-input">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="brand-textarea" rows="4"></textarea>
                            </div>
                            <div class="text-end">
                                <button class="dg-brand-btn">Submit Review</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="viewAllReviewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="reservationRefundModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <div class="container">
                        <div class="rrp-content">
                            <h5 class="text-center mb-4">Thankyou for your interest in reserving a vehicle on WheelPact!</h5>
                            <ul class="rrf-list">
                                <li>
    ...
    <header>
                            ...
                            <label class="open-menu-login-account" for="open-menu-login-account">
                                ...
                                <ul class="login-list">
                                    <a href="#" data-bs-target="#loginModal" data-bs-toggle="modal">
                                        <li class="login-list-item">Login / Sign up</li>
                                    </a>
                                    <a href="profile.php">
                                        <li class="login-list-item">Profile Info</li>
                                    </a>
                                    <a href="wishlist.php">
                                        <li class="login-list-item">Wishlist</li>
                                    </a>
                                    <a href="#">
        ...
        <div class="offcanvas offcanvas-start mob-offcanvas" tabindex="-1" id="offcanvasLeft" aria-labelledby="offcanvasLeftLabel">
            <div class="offcanvas-header mob-menu-header">
                <div class="mob-menu-user">
                    <span class="mob-login-text">Hello, User</span>
                </div>
            ...
            <div class="offcanvas-body mob-menu-body">
                <ul class="mob-nav-list">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal">
                        <li><i class="icofont-login"></i>Login / Sign Up</li>
                    </a>
                    <a href="profile.php">
                        <li><i class="icofont-user"></i>Profile Info</li>
                    </a>
                    <a href="wishlist.php">
                        <li><i class="icofont-heart"></i> Wishlist</li>
                    </a>
                    <a href="#">
                        <li><i class="icofont-logout"></i>Logout</li>
                    </a>
                </ul>
