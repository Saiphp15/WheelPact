        ...
        <div class="row align-items-center">
                ...
                <div class="banner-search">
                    <ul class="nav nav-pills mb-3 banner-filter-pills" id="pills-tab" role="tablist">
                        <li class="nav-item banner-filter-item" role="presentation">
                            <button class="nav-link banner-filter-link active" id="pills-cars-tab" data-bs-toggle="pill" data-bs-target="#pills-cars" type="button" role="tab" aria-controls="pills-cars" aria-selected="true">Cars</button>
                        </li>
                        <li class="nav-item banner-filter-item" role="presentation">
                            <button class="nav-link banner-filter-link" id="pills-bikes-tab" data-bs-toggle="pill" data-bs-target="#pills-bikes" type="button" role="tab" aria-controls="pills-bikes" aria-selected="false">Bikes</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-cars" role="tabpanel" aria-labelledby="pills-cars-tab">
                        ...
                        <div class="tab-pane fade" id="pills-bikes" role="tabpanel" aria-labelledby="pills-bikes-tab">
                            <div class="input-group mb-3">
            ...
            <div class="col-md-6">
                <div class="banner-img">
                    <img class="img-fluid" src="assets/images/banner-image.jpg">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="carousel-wrapper mt-3">
            <div id="popular-carWrapper-carousel" class="owl-carousel owl-theme">
                <div class="item">
                    <a href="#">
                        <div class="store-wrapper">
                            <img src="https://content.jdmagicbox.com/comp/mumbai/d1/022pxx22.xx22.140728162311.i1d1/catalogue/car-galaxy-thane-west-thane-car-dealers-p3q87.jpg?clr=">
                ...
                <div class="item">
                    <a href="#">
                        <div class="store-wrapper">
                            <img src="https://content.jdmagicbox.com/comp/mumbai/n7/022pxx22.xx22.180328045415.k9n7/catalogue/s-m-carz-borivali-west-mumbai-second-hand-car-dealers-yqx9eilx8l.jpg?clr=523314">
                            <div class="store-details-box">
                                <div class="store-wrapper-title">
                                    <h5>Heritage Cars</h5>
                                </div>
    ...
    <div class="container">
        ...
        <div class="carousel-wrapper mt-3">
            <div id="testimonials-carousel" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="testimonials-wrapper">
                        <img src="https://media.istockphoto.com/photos/portrait-of-a-happy-mature-black-businessman-picture-id1145045307?k=20&m=1145045307&s=612x612&w=0&h=ExPTczH5py4-Gd5v1gG3NH8tbBucrfmZ-5yE0d0quL8=">
