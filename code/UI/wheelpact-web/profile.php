        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-pinfo" role="tabpanel" aria-labelledby="v-pills-pinfo-tab">
                        ...
                        <div class="tab-content-wrap">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="brand-label mb-1">Mobile Number<span class="required">*</span></label>
                    ...
                    <div class="tab-pane fade" id="v-pills-refer-earn" role="tabpanel" aria-labelledby="v-pills-refer-earn-tab">
                        <div class="tab-title mb-4">
                            <h4>Refer & Earn</h4>
                        </div>
