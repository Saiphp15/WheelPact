...
const navigate = useNavigate();
  ...
  const handleSugnUpSubmit = async (event) => {
  ...
  return (
    <div>
              ...
              <div className="container">
                ...
                <form method="post" onSubmit={handleSigninSubmit}>
                  <div className="login-input mt-4">
                    <label className="brand-label mb-1">
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body">
              ...
              <div className="container">
                <ToastContainer />
                <form method="POST" onSubmit={handleSugnUpSubmit}>
                  <div className="login-input mt-4">
                    <div className="row">
                  ...
                  <div className="modal-notify">
                    <p>
                      By SugnUp , I agree to{" "}
                      <Link to="/">Terms & Conditions</Link> and{" "}
                      <Link to="/">Privacy Policy</Link>
                    </p>
                  </div>
                  <div className="text-center mt-4">
                    <button type="submit" className="dg-brand-btn">
                      Submit
                    </button>
                  </div>
                </form>
      ...
      {/* <!-- OTP MODAL STARTS --> */}
      <div
        className={`modal fade ${showOTPModal ? "show" : ""}`}
        id="otpModal"
        aria-labelledby="exampleModalLabel"
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body">
              ...
              <div className="modal-notify">
                <p>
                  Enter the OTP sent to <span id="loginNumberShow"></span>
                </p>
              </div>
              ...
              <div className="container">
                ...
                <div className="modal-otp-notify">
                  <p>
                    Resend OTP in <span id="countdownTimer">30</span> seconds
                  </p>
                </div>

                <div className="text-center mt-4 resend-otp-btn">
                  <Link to="/" className="dg-brand-btn">
                    Resend
                  </Link>
                </div>
              </div>
              ...
              <div className="container">
                <div className="rrp-content">
                  <h5 className="text-center mb-4">
                    Thankyou for your interest in reserving a vehicle on
                    WheelPact!
                  </h5>
                  <ul className="rrf-list">
                    <li>
                      <p>
                        The Reservation Refund Policies are mentioned below:
                      </p>
                    </li>
                    <li>
                      <p>
                        1. The Reservation fee is refundable when the visiting
                        person rejects the vehicle and the reservation cancelled
                        request has been raised by the Partner Dealer.
                      </p>
                    </li>
                    <li>
                      <p>
                        2. The Reservation fee in non-refundable if the person
                        does not visit the vehicle on the scheduled date and
                        time.
                      </p>
                    </li>
                    <li>
                      <p>
                        3. The Reservation fee is non-refundable until the
                        scheduled date & time.
                      </p>
                    </li>
                    <li>
                      <p>
                        4. The 10% service charge mentioned in Bill Summary is
                        non-refundable in any case, only the reservation fee
                        will be refunded.
                      </p>
                    </li>
                  </ul>
